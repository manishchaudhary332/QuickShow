...
const TrailersSeaction = () => {

    const [currentTrailer, setcurrentTrailer] = useState(dummyTrailers[0])
    
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        <p className='text-gray-200 font-medium text-lg max-w-[960px]'>Trailers</p>
    <div className='relative mt-6'>
        <BlurCircle top="-100px" righ="-100px"/>
...
export default TrailersSeaction